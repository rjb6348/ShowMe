class Artist(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.spotify_data = False
        self.artist_json = None
        self.artist_name = None
        self.artist_images = None
        self.artist_genres = None
        self.spotify_url = None
        self.spotify_artist_json = {}

        self.songkick_data = False
        self.artist_touring_until = None
        self.artist_id = None
        self.songkick_artist_json = None
        self.disply_name = None
        self.songkick_url = None
        self.songkick_artist_json = {}
    ...
    def add_songkick_data(self, artist_json):
        self.songkick_artist_json = artist_json
        self.disply_name = self.songkick_artist_json['displayName']
        self.artist_id = self.songkick_artist_json['id']
        self.artist_touring_until = self.songkick_artist_json['onTourUntil']
        self.songkick_url = self.songkick_artist_json['uri']
        self.songkick_data = True
